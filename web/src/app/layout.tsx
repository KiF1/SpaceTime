    ...
    <html lang="en">
      <body className={`${roboto.variable} ${baiJamjuree.variable} font-sans bg-gray-900 text-gray-100`}>
        <main className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
          <div className="flex bg-[url(../assets/bg-stars.svg)] bg-cover flex-col items-start justify-between p-8 gap-16 md:px-28 md:py-16 relative overflow-hidden border-r border-white/10">
          ...
          <div className="flex flex-col max-h-screen md:overflow-y-scroll bg-[url(../assets/bg-stars.svg)] bg-cover">
            {children}
          </div>
        </main>
      </body>
